...
<?php if ($cyc_options['captcha']) { ?>
			...
			<label for="security_code">Taper le code:</label>
...
function cyc_show_loginform() {
	...
	cyc_head("Connection &agrave; votre compte ");	
	...
	<form class="loginform" action="<?php bloginfo('wpurl'); ?>/wp-login.php" method="post" >
		<p>
			...
			<label for="rememberme"><?php _e('Se souvenir de moi'); ?></label>
		</p>
		<p class="submit">
			<input type="submit" name="wp-submit" id="wp-submit" value="<?php _e('Se connecter'); ?> &raquo;" />
