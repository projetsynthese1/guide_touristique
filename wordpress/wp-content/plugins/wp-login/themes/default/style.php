...
include("../../../../../wp-load.php");
$wzcl_options = get_option('wzcl_custom_login_options');
$options = array(
	'background'=>(strlen($wzcl_options['colors']['background'])>0) ? "#".$wzcl_options['colors']['background'] : "transparent",
	'login_background'=>(strlen($wzcl_options['colors']['login_background'])>0) ? "#".$wzcl_options['colors']['login_background'] : "transparent",
	'label_font_color'=>(strlen($wzcl_options['colors']['label_font_color'])>0) ? "#".$wzcl_options['colors']['label_font_color'] : "#333",
	'link_font_color'=>(strlen($wzcl_options['colors']['link_font_color'])>0) ? "#".$wzcl_options['colors']['link_font_color'] : "#333",
	'link_font_shadow_color'=>(strlen($wzcl_options['colors']['link_font_shadow_color'])>0) ? "#".$wzcl_options['colors']['link_font_shadow_color'] : "#ccc",
	'logo'=>(strlen($wzcl_options['images']['logo'])>0) ? $wzcl_options['images']['logo'] : "../../../../../wp-admin/images/logo-login.png",
	'hide_back_to_link'=>(strlen($wzcl_options['style']['hide_back_to_link'])>0) ? $wzcl_options['style']['hide_back_to_link'] : "No",
	'disable'=>(strlen($wzcl_options['style']['disable'])>0) ? $wzcl_options['style']['disable'] : "No",
	'login_type'=>(strlen($wzcl_options['general']['login_type'])>0) ? $wzcl_options['general']['login_type'] : "new",
);
?>

<?php if($options['hide_back_to_link']=="Yes"): ?>
#backtoblog{
	display: none;
}
<?php endif; ?>

<?php if($options['login_type']=="new"): //Start if it is the login form inside of the theme ?>
<?php /*
...
<?php /* PLEASE BECAREFUL EDITING THE VALUES BELOW */ ?>

<?php if($wzcl_options['general']['login_type']=="current"): //Only show these options to default login page ?>
#login h1 a { background: url('<?php echo $options['logo']; ?>') no-repeat top center; } 
html{
...
.login #wpnav a, .login #backtoblog a {
